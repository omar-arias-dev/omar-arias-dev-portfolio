...
export default function IconLinkedin(props) {
    return (
        <svg
            className="about_me-spotlight-social_link-stroked"
            viewBox="0 0 24 24"
            fill="currentColor"
            height="1em"
            width="1em"
